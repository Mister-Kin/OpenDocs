...
\begin{document}
    ...
    \markright{版权声明}
    \noindent 作者：Mr. Kin \\
    博文：\href{https://mister-kin.github.io/OneClickSwitchLanguage}{跳转博文页}\\
    相关视频创作：\href{}{跳转视频页}\\ %无视频则注释掉此行
    PDF及Tex源码：\href{https://github.com/Mister-Kin/OpenDocs/tree/master/Articles/OneClickSwitchLanguage}{跳转PDF及Tex源码页}\\
