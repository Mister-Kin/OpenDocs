\documentclass{../../PublicResources/DocClass}
    ...
    \LinkBlogPost{}
    \LinkBlogPostMirror{}
    \LinkPDF{https://pan.baidu.com/s/1Tn7qIO0raqvNoesgT8SKow}
...
\begin{longtable}{|*{6}{c|}}
    ...
    \multirow{3}{*}{Adobe\&Google} & \href{https://github.com/adobe-fonts/source-han-sans/releases}{思源黑体} & Source Han Sans SC & 简繁日韩|黑 & \multirow{2}{*}{SIL OFL, v1.1} & v2.004 \\
    \cline{2-4} \cline{6-6}
    & \href{https://github.com/adobe-fonts/source-han-serif/tree/release}{思源宋体} & Source Han Serif SC & 简繁日韩|宋 & & v1.001 \\
    \cline{2-6}
    & \multicolumn{5}{l|}{注：均选用Language-specific SC版。Adobe版为思源，google版为NOTO(no toufo)。} \\
    \hline
