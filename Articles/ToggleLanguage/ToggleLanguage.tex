...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item 用以选择UI提示方案的菜单
    \end{itemize}
    \noindent {\footnotesize \emph{注：详细介绍请查看「\hyperlink{UsingAddon}{使用插件}」小节内容，规划中的功能请\href{https://mister-kin.github.io/roadmap/}{跳转蓝图规划页}查看。}}
    ...
    \begin{figure}[htbp]
        \begin{minipage}[t]{0.45\textwidth}
            \includegraphics[scale=0.32]{UI}
            \caption*{插件UI}
        \end{minipage}
        \qquad
        \begin{minipage}[t]{0.45\textwidth}
            \includegraphics[scale=0.28]{OptionForHintScheme}
            \caption*{提示方案有关的选项}
        \end{minipage}
    \end{figure}
    ...
    \begin{tabular}{|*{2}{c|}p{240pt}|c|}
        ...
        \hline
        v0.5-beta & 2020/9/20 & 添加菜单用以选择UI提示方案 & New features\\
        \hline
        v0.4 & 2020/8/3 & 代码项目重命名为ToggleLanguage；按钮UI放置于最右端；添加新按钮以快速查看preferences & New features \\
        \hline
        v0.3 & 2020/6/5 & 更新至blender 2.83 api；修改部分类名；添加文档链接；修改完善许可说明 & Minor changes \\
        \hline
        v0.2 & 2020/5/21 & 清除未使用属性的报错 & Bug fixes \\
        \hline
        v0.1 & 2020/5/12 & 完成基础的功能设计「一键切换」 & New features \\
        \hline
    \end{tabular}
    \end{table}
