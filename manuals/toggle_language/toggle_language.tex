\documentclass{../../public_resources/doc}
    ...
    \DocumentCoverImage{tl-cover}
    \DocumentCoverImageScale{0.2}
    \DocumentCoverImageTopMargin{10ex}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{check-addon-update-button}
        \caption{点击插件的「检查插件更新」按钮}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{update-success}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{tab-get-extensions}
        \caption{获取扩展选项卡}
        \label{获取扩展选项卡}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{tab-addon}
        \caption{插件选项卡}
        \label{插件选项卡}
    \end{minipage}
\end{figure}
...
\begin{figure}[h!]
    ...
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{enable-addon}
        \caption{启用插件}
        \label{启用插件}
    \end{minipage}
\end{figure}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{toggle-language-button}
        \caption{「语言切换」按钮}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{toggle-language-button-setting}
        \caption{「语言切换」功能设置}
        \label{「语言切换」功能设置}
    \end{minipage}
\end{figure}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{before-dellete}
        \caption{删除前的效果}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{after-dellete}
        \caption{删除后的效果}
    \end{minipage}
\end{figure}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{video-progress-bar-meta-strip}
        \caption{视频进度条-复合片段}
        \label{视频进度条-复合片段}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{video-progress-bar-child-strip}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{import-blueprint}
        \caption{「导入蓝图（参考图）」功能}
        \label{「导入蓝图（参考图）」功能}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{import-blueprint-setting}
...
\begin{figure}[h!]
    \includegraphics[width=\linewidth]{setting-menu}
    \caption{实用工具菜单}
\end{figure}
...
\begin{figure}[h!]
    \includegraphics[width=\linewidth]{hint-menu}
    \caption{UI提示方案菜单}
\end{figure}

\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{default-hint}
        \caption{UI 提示方案菜单：默认模式}
        \label{UI 提示方案菜单：默认模式}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{developer-hint}
...
\begin{figure}[h!]
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{translate-name-option-addon}
        \caption{插件中的翻译新建数据块名称的选项}
        \label{插件中的翻译新建数据块名称的选项}
    \end{minipage}
    \quad
    \begin{minipage}[t]{0.48\linewidth}
        \includegraphics[width=\linewidth]{translate-name-option-pref}
...
\begin{figure}[h!]
    \includegraphics[width=\linewidth]{translate-name-option-effect}
...
\begin{figure}[h!]
    \includegraphics[width=\linewidth]{settings-for-loading-my-settings}
...
\begin{figure}[h!]
    \includegraphics[width=\linewidth]{addon-keymaps}
    \caption{插件的键位映射功能}
    \label{插件的键位映射功能}
\end{figure}
