...
\section{用法}
若想获取插件的最新功能，请下载\href{https://github.com/Mister-Kin/ToggleLanguage/archive/refs/heads/master.zip}{项目代码master分支}的最新代码，然后参照本地安装步骤进行安装即可。
