...
\noindent {\bfseries \sffamily 作者：}Mr. Kin \\
\DetectToksEmpty\LinkBlogPost
\ifToksEmpty
{\bfseries \sffamily 博文链接：}链接暂空\\
\else
{\bfseries \sffamily 博文链接：}\href{\the\LinkBlogPost}{跳转博文页}\\
\fi
\DetectToksEmpty\LinkPDFSource
\ifToksEmpty
{\bfseries \sffamily PDF及LaTeX源码链接：}链接暂空\\
\else
{\bfseries \sffamily PDF及LaTeX源码链接：}\href{\the\LinkPDFSource}{跳转PDF及LaTeX源码页}\\
\fi
\DetectToksEmpty\LinkVideo
\ifToksEmpty
\else
{\bfseries \sffamily 相关视频创作链接：}\href{\the\LinkVideo}{跳转视频页}\\
\fi
{\bfseries \sffamily 许可协议：}本作品的所有内容，除个人设计创作的图像（如logo等）和相关的视频创作及其他特别声明外，均采用\href{https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh}{知识共享\ 署名-非商业性使用-相同方式共享 4.0 国际许可协议}进行发布。版权 © Mr. Kin，保留所有权利。\includegraphics[scale=.4]{CC-BY-NC-SA}\\*[1.3ex]
